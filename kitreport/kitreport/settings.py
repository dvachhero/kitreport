"""
Django settings for kitreport project.
...
SECRET_KEY = 'django-insecure-_z))ey!^cjs#rbk*t7!w(qmw5es#&eabs9!jm69f&j$xswz0tb'
...
ROOT_URLCONF = 'kitreport.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'kitreport', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
